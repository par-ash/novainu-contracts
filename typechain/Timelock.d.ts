...
interface TimelockInterface extends ethers.utils.Interface {
  functions: {
    ...
    "initNlpManager()": FunctionFragment;
    "initRewardRouter()": FunctionFragment;
    ...
    "setNlpCooldownDuration(uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "initNlpManager",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setNlpCooldownDuration",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
...
export class Timelock extends BaseContract {
  ...
  callStatic: {
    ...
    initNlpManager(overrides?: CallOverrides): Promise<void>;

    initRewardRouter(overrides?: CallOverrides): Promise<void>;
