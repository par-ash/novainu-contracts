...
interface NovaMigratorInterface extends ethers.utils.Interface {
  functions: {
  ...
  encodeFunctionData(functionFragment: "novaPrice", values?: undefined): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "novaPrice", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "pendingActions",
    data: BytesLike
  ): Result;
...
export class NovaMigrator extends BaseContract {
  ...
  interface: NovaMigratorInterface;
  ...
  functions: {
    ...
    novaPrice(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    ...
    novaPrice(overrides?: CallOverrides): Promise<PopulatedTransaction>;
