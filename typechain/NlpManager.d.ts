...
interface NlpManagerInterface extends ethers.utils.Interface {
  functions: {
    "BASIS_POINTS_DIVISOR()": FunctionFragment;
    "MAX_COOLDOWN_DURATION()": FunctionFragment;
    "NLP_PRECISION()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "NLP_PRECISION",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export class NlpManager extends BaseContract {
  ...
  functions: {
    ...
    NLP_PRECISION(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    ...
    NLP_PRECISION(overrides?: CallOverrides): Promise<PopulatedTransaction>;
