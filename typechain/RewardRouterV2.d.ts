...
interface RewardRouterV2Interface extends ethers.utils.Interface {
  functions: {
    ...
    "nlpVester()": FunctionFragment;
    "nova()": FunctionFragment;
    "novaVester()": FunctionFragment;
  ...
  encodeFunctionData(functionFragment: "nlpVester", values?: undefined): string;
  encodeFunctionData(functionFragment: "nova", values?: undefined): string;
  encodeFunctionData(
    functionFragment: "novaVester",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "nlpVester", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "nova", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "novaVester", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "pendingReceivers",
    data: BytesLike
  ): Result;
  ...
  events: {
    ...
    "StakeNova(address,address,uint256)": EventFragment;
    "UnstakeNlp(address,uint256)": EventFragment;
    "UnstakeNova(address,address,uint256)": EventFragment;
  };
...
export class RewardRouterV2 extends BaseContract {
  ...
  functions: {
    ...
    handleRewards(
      _shouldClaimNova: boolean,
      _shouldStakeNova: boolean,
      _shouldClaimEsNova: boolean,
      _shouldStakeEsNova: boolean,
    ...
    nlpVester(overrides?: CallOverrides): Promise<[string]>;

    nova(overrides?: CallOverrides): Promise<[string]>;

    novaVester(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    nlpVester(overrides?: CallOverrides): Promise<BigNumber>;

    nova(overrides?: CallOverrides): Promise<BigNumber>;

    novaVester(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    nlpVester(overrides?: CallOverrides): Promise<PopulatedTransaction>;

    nova(overrides?: CallOverrides): Promise<PopulatedTransaction>;

    novaVester(overrides?: CallOverrides): Promise<PopulatedTransaction>;
