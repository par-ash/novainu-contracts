...
async function main() {
  ...
  const output = {
    novaPrice: baseData.novaPrice,
    esnovaRewards: baseData.esnovaRewards,
  ...
  output.referrers = baseData.referrers.map(x => {
    ...
    return {
      ...
      esnovaRewards: BigNumber.from(x.esnovaRewards || 0).sub(BigNumber.from(y.esnovaRewards || 0)).toString(),
      baseEsnovaRewards: x.esnovaRewards || 0,
      otherEsnovaRewards: y.esnovaRewards || 0,

      esnovaRewardsUsd: BigNumber.from(x.esnovaRewardsUsd || 0).sub(BigNumber.from(y.esnovaRewardsUsd || 0)).toString(),
      baseEsnovaRewardsUsd: x.esnovaRewardsUsd,
      otherEsnovaRewardsUsd: y.esnovaRewardsUsd,
