...
const { DISTRIBUTION_LIST } = require("../../data/esNovaDistribution/distributionList1")
...
async function main() {
  ...
  await sendTxn(esNova.approve(batchSender.address, expandDecimals(100 * 1000, 18)), "esNova.approve")
