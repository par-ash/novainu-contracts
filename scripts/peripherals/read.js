...
async function readNlpManager(nlpManager) {
  console.log("nlpManager.cooldownDuration", (await nlpManager.cooldownDuration()).toString())
}
...
async function main() {
  ...
  // const nova = { address: "0xfc5A1A6EB076a2C7aD06eD22C90d7E710E35ad0a" }
  ...
  // await readNlpManager(nlpManager)

  // await getPool(weth.address, usdc.address, 500)
  // await getPool(weth.address, nova.address, 10000)
  ...
  startTime = Date.now()
  await nlpManager.getAums()
  console.log("nlpManager.getAums", Date.now() - startTime)
}
