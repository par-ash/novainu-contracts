...
async function getArbValues() {
  return {
    serverHost: "http://localhost:8080", //"https://nova-server-mainnet.uw.r.appspot.com",
...
async function getAvaxValues() {
  return {
    serverHost: "https://nova-avax-server.uc.r.appspot.com",
...
async function getVaultData(vault, indexTokens, blockNumber) {
  console.log("Getting vault data: {}, {}, {}", vault, indexTokens, blockNumber);
